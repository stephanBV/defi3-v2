...
* @author Cyril 
*/
contract Voting_cyril is Ownable {
   ...
   // ::::::::::::: GETTERS ::::::::::::: //
    ...
    /** 
    * @dev allows the caller to get info about a voter
    * @dev only voters can call that function
    * @param  _addr {address} is the voter's address
    * @return Voter's struct data in memory
     */
    ...
    /**
     * @dev allows the caller to retrieve a proposal from its id
    ...
    /**
     * @dev allows the caller to retrieve the winning proposals 
     * @return an array of all winners in case of draw
     */
    ...
    /**
     * @dev allows the caller to register a voter
    ...
    /**
     * @dev allows the caller to add a proposal
    ...
    /**
    * @dev allows the caller to vote
    * @dev only voters can make that transaction
    * @dev emit Voted event 
    * @param _id {uint} - the proposal's description
    */
    ...
    /**
    * @dev allows the caller to start the proposal registering
    * @dev only admin can make that transaction
    ...
    */
    ...
    /**
    * @dev allows the caller to end the proposal registering
    * @dev only admin can make that transaction
    * @dev emit WorkflowStatusChange event 
    */
    ...
    /**
    * @dev allows the caller to start the voting session
    * @dev only admin can make that transaction
    * @dev emit WorkflowStatusChange event 
    */
    ...
    /**
    * @dev allows the caller to end the voting session
    * @dev only admin can make that transaction
    * @dev emit WorkflowStatusChange event 
    */
    ...
    /**
    * @dev allows the caller to count the votes
    * @dev only admin can make that transaction
    * @dev emit WorkflowStatusChange event 
    */
